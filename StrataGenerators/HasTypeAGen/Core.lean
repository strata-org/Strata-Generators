...
/-- A generator for a `Nat`.
    ...
    module imports the full `Basalt` library. `Basalt` gives `List.uniq` of Mathlib, which collides
    with `List.uniq` of Strata. This file must stay free of Mathlib. The definition here is
